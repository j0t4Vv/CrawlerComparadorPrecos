    ...
    public ProdutoScraper ObterPreco(string descricaoProduto, int idProduto)
    {
        ...
        try
        {
            ...
            if (firstProductPriceNode != null)
            {
                ...
                RegistroLog.RegistrarLog("0000088538", "JoãoVictor", DateTime.Now, "WebScraping - Mercado Livre", "Sucesso", idProduto);
            ...
            else
            {
                ...
                // Registra o log com o ID do produto
                RegistroLog.RegistrarLog("0000088538", "JoãoVictor", DateTime.Now, "WebScraping - Mercado Livre", "Preço não encontrado", idProduto);
        ...
        catch (Exception ex)
        {
            ...
            // Registra o log com o ID do produto
            RegistroLog.RegistrarLog("0000088538", "JoãoVictor", DateTime.Now, "Web Scraping - Mercado Livre", $"Erro: {ex.Message}", idProduto);
